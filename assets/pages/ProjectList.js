...
function ProjectList() {
  ...
  const handleDelete = (id) => {
    Swal.fire({
      ...
      confirmButtonText: "Yes, defo delete!",
    }).then((result) => {
                  ...
                  return (
                    <tr key={key}>
                      ...
                      <td>
                        ...
                        <Link className="btn btn-outline-success mx-1" to={`/edit/${project.id}`}>
                          Edit
                        </Link>
                        <button onClick={() => handleDelete(project.id)} className="btn btn-outline-danger mx-1">
                          Delete
                        </button>
                      </td>
                    </tr>
